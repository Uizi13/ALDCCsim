...
This is why I additionally implemented [search mode](!!!) which uses bisection to find some element parameter knowing one of the currents, voltages or power balances. 
